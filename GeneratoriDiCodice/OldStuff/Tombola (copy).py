...
def Estrai():
    ...
    if posizione == 90:
        ...
        print("Fine. Successione Numeri estratti:") #Tabellone completo
        print(NumeriEstratti)
        print("")
        return
    ...
    posizione += 1 # Pronto pet il successivo
